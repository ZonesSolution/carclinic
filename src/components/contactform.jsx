...
const Contactform = () => {
    return (
        <div className="relative h-screen">
            ...
            ></div>
            <div className="absolute inset-0 flex px-28 items-center gap-20">
                <div className='flex flex-col w-1/2'>
                    <div>
                        <h3 className='text-white text-3xl font-bold pb-2'>TRUST OUR SERVICE TO GET <br></br> YOU BACK ON THE ROAD</h3>
                        <p className='text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br></br> Ut elit tellus, luctus nec ullamcorper mattis, pulvinar</p>
                    </div>
                ...
                <div className='bg-white rounded-2xl px-8 py-12 flex flex-col w-1/2'>
